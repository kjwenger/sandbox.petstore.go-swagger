...
import (
	...
	"github.com/kjwenger/sandbox.petstore.go-swagger/restapi/operations"
	"github.com/kjwenger/sandbox.petstore.go-swagger/restapi/operations/pet"
	"github.com/kjwenger/sandbox.petstore.go-swagger/restapi/operations/store"
	"github.com/kjwenger/sandbox.petstore.go-swagger/restapi/operations/user"
)

// This file is safe to edit. Once it exists it will not be overwritten

//go:generate swagger generate server --target .. --name petstore --spec ../../../../../../../../com.u14n/development/projects/sandbox/sandbox.petstore/swagger.json
